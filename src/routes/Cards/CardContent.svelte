...
<div class="pt-28">
	<div>
		...
		<div class="flex justify-between items-center">
			...
			<button class="text-2xl font-semibold flex items-center gap-2"
				>More
				<svg
					width="20"
					height="20"
